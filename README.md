...
[7] [Properties of two-stage stochastic multi-objective linear programs](https://link.springer.com/article/10.1007/s10107-025-02280-7). Gupta, A. and Hunter, S.R., 2025; *Mathematical Programming* (pp. 1-37).

[6] [Global Task-Aware Fault Detection Identification for On Orbit Multi-Spacecraft Collaborative Inspection]([https://www.arxiv.org/abs/2505.03088](https://www.space-flight.org/docs/2023_winter/33rdSFFM-Full_Program_Abstracts.pdf)). Gupta, A., Nakka, Y.K., Choi, C. and Rahmani, A., 2023; *33rd AAS/AIAA Space Flight Mechanics Meeting* (p. 68).

[5] [Empirical Analysis of UAS Performance under External Wind](https://arc.aiaa.org/doi/full/10.2514/6.2022-0199). Gupta, A., Hsu, W.C., Shethia, S. and Hwang, I., 2022; *AIAA SCITECH 2022 Forum* (p. 0199).

[4] [Contact residue contributions to interaction energies between SARS-CoV-1 spike proteins and human ACE2 receptors](https://www.nature.com/articles/s41598-020-80942-6). Rodriguez, J.H. and Gupta, A., 2021; *Scientific reports*, 11(1) (p. 1156).

[3] [Distributed fast-tracking alternating direction method of multipliers (ADMM) algorithm with optimal convergence rate](https://ieeexplore.ieee.org/abstract/document/9658615). Shethia, S., Gupta, A., Thapliyal, O. and Hwang, I., 2021, October; *2021 IEEE International Conference on Systems, Man, and Cybernetics (SMC)* (pp. 976-981).

[2] [Empirical Analysis of Battery Performance with Ambient Temperature for Small Electric UASs](https://arc.aiaa.org/doi/full/10.2514/6.2021-3004). Gupta, A., Shethia, S., Hsu, W.C. and Hwang, I., 2021; *AIAA AVIATION 2021 FORUM* (p. 3004).

[1] [Analysis, diagnosis and correction of rain streaks](https://ieeexplore.ieee.org/abstract/document/8929392). Kumar, S., Gupta, A. and Jha, R.K., 2019, October; *TENCON 2019-2019 IEEE Region 10 Conference (TENCON)* (pp. 2700-2704).
